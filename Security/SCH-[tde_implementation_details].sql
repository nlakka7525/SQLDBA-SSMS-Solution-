...
(
	...
	total_database_count smallint,
	encryption_start_time datetime2 not null default sysdatetime(),
	encryption_end_time datetime2 null,
	local_backup_directory varchar(2000) not null,
	remote_backup_directory varchar(2000) null,
	certificate_name varchar(125) null,
	certificate_subject varchar(500) null,
	encryption_password varchar(500) null,
	certificate_file_path varchar(2000) null,
	master_key_path varchar(2000) null,
	private_key_path varchar(2000) null,
