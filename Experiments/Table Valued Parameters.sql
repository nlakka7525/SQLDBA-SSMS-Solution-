...
/*	https://learn.microsoft.com/en-us/sql/relational-databases/tables/use-table-valued-parameters-database-engine?view=sql-server-ver16
	...
	ISSUE -> SQL Server does not maintain statistics on columns of table-valued parameters.
...
insert @UserTable 
values (1),(4449743),(26837),(545629),(61305),(440595),(4197),(17174);

exec dbo.usp_GetUsersPosts_TVP @UserTable;
go
